import {EventDispatcher, Vector2, Vector3, Quaternion,Spherical, MOUSE, OrthographicCamera, PerspectiveCamera} from "three";
...
export function OrbitControls( object, domElement ) {
	...
	this.update = function() {
		...
		return function update () {
			...
			// rotate offset to "y-axis-is-up" VOID
			...
			// rotate offset back to "camera-up-vector-is-up" VOID
