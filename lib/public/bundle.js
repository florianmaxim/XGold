...
var _reducerBlocks = _interopRequireDefault(__webpack_require__(114));
...
var _Block = _interopRequireDefault(__webpack_require__(124));
...
var _default = function _default(About) {
  return _react.default.createElement(_About_.Heading, null, _react.default.createElement("h1", null, "XGold"));
};
...
var _Block_ = __webpack_require__(125);

var _containerBlocks = _interopRequireDefault(__webpack_require__(126));
...
var blocks = _interopRequireWildcard(__webpack_require__(127));
  ...
  _createClass(ContainerBlocks, [{
    ...
    value: function componentDidMount() {
      ...
      addEventListener('click', function () {
        return _this.props.fetchBlocks();
      });
    }
  }, {
    key: "render",
    value: function render() {
      if (!this.props.blocks) {
        return _react.default.createElement("h2", null, "No blocks loaded.");
      }

      return _react.default.createElement("h2", null, "Current Height Of The Ethereum Blockchain: ", this.props.blocks.height);
    }
  }]);
...
var _default = (0, _reactRedux.connect)(props, actions)(ContainerBlocks);
/*
 {
